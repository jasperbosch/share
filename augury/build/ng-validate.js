...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var message_dispatch_1 = __webpack_require__(70);
	var message_factory_1 = __webpack_require__(38);
	var message_type_1 = __webpack_require__(16);
	...
	var handler = function () {
	    ...
	    message_dispatch_1.browserSubscribeOnce(message_type_1.MessageType.Initialize, function () {
	        indirect_connection_1.send(message_factory_1.MessageFactory.notNgApp());
	    });
	    indirect_connection_1.send(message_factory_1.MessageFactory.notNgApp());
	    return false;
	};
